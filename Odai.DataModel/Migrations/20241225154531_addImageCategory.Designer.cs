...
namespace Odai.DataModel.Migrations
{
    ...
    [Migration("20241225154531_addImageCategory")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Odai.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Odai.Domain.Entities.Basket", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Odai.Domain.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Odai.Domain.Entities.Basket", b =>
                {
                    b.HasOne("Odai.Domain.Entities.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
            ...
            modelBuilder.Entity("Odai.Domain.Entities.BasketItem", b =>
                {
                    b.HasOne("Odai.Domain.Entities.Basket", "Basket")
                        .WithMany("BasketItems")
                        .HasForeignKey("BasketId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Odai.Domain.Entities.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("Odai.Domain.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("Odai.Domain.Entities.ApplicationUser", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Odai.Domain.Entities.OrderItem", b =>
                {
                    b.HasOne("Odai.Domain.Entities.Order", "Order")
                        .WithMany("OrderItems")
